...
async function generateInitCode(
    ...
    const factory = await hre.ethers.getContractAt("SmartWalletFactory", factoryAddress);
    ...
    try {
        ...
        console.log("  Account doesn't exist, will be created. Gas estimate:", gasEstimate.toString());
