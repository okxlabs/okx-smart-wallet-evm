 ...
 * @notice Validator for Passkey signatures using P256 verification with SmartAccount compatibility
 * @dev Implements IValidator interface for P256 signature verification
 *      Note: Applies SHA256 to messageHash to match existing signing libraries (ec-pem + crypto.createSign)
 */
